...
CLEANUP_SCENE_SIMILARITY_MIN = float(os.getenv('CLEANUP_SCENE_SIMILARITY_MIN', '0.30'))
CLEANUP_PATCH_SIMILARITY_MIN = float(os.getenv('CLEANUP_PATCH_SIMILARITY_MIN', '0.07'))
# SSIM on YOLO waste-area crop (256×256 grey): min = same spot, max = no visible cleanup
CLEANUP_PATCH_SSIM_MIN = float(os.getenv('CLEANUP_PATCH_SSIM_MIN', '0.07'))
